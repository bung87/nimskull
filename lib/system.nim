...
when notJSnotNims:
  ...
  proc rawProc*[T: proc {.closure.} | iterator {.closure.}](x: T): pointer {.noSideEffect, magic: "AccessProc".} =
  ...
  proc rawEnv*[T: proc {.closure.} | iterator {.closure.}](x: T): pointer {.noSideEffect, magic: "AccessEnv".} =
